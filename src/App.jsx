...
//           audioChunksRef.current.push(e.data); // ⏺️ Accumulate chunks
//         }
//       };

//       mediaRecorder.onstop = () => {
//         console.log("🛑 MediaRecorder stopped. Preparing to send final audio...");
...
//             console.log("📤 Sending full audio blob of size:", arrayBuffer.byteLength);
//             socket.send(arrayBuffer);
//           } else {
//             console.warn("⚠️ Socket not open when trying to send final audio");
//           }
//         };
...
//       mediaRecorder.start(); // No interval — just record
